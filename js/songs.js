...
const SONGS = [
  ...
  // ──────────────────────────────────────────
  {
    ...
    chords: ['C','G/B','Am7','Am7/G','Fmaj9','C/E','Dsus4','D','Gsus4','G','Dm7','Em','D/F#'],
    sections: [
      { title: '主歌一', lines: [
        [{ chord:'C', lyric:'还没好好的感受' }, { chord:'G/B', lyric:'' }, { chord:'Am7', lyric:'雪花绽放的气候' }, { chord:'Am7/G', lyric:'' }],
        [{ chord:'Fmaj9', lyric:'我们一起颤抖 会更明白' }, { chord:'C/E', lyric:'' }, { chord:'Dsus4', lyric:'甚么' }, { chord:'D', lyric:'' }, { chord:'Gsus4', lyric:'是温' }, { chord:'G', lyric:'柔' }],
        [{ chord:'C', lyric:'还没跟你牵着手' }, { chord:'G/B', lyric:'' }, { chord:'Am7', lyric:'走过荒芜的沙丘' }, { chord:'Am7/G', lyric:'' }],
        [{ chord:'Fmaj9', lyric:'不能从此以后 学会珍惜' }, { chord:'C/E', lyric:'' }, { chord:'Dm7', lyric:'天长和' }, { chord:'Gsus4', lyric:'地' }, { chord:'G', lyric:'久' }],
      ]},
      { title: '副歌', lines: [
        [{ chord:'C', lyric:'有时候 有时候 我会相信一切有尽头' }, { chord:'G/B', lyric:'' }, { chord:'Am7', lyric:'' }, { chord:'Am7/G', lyric:'' }],
        [{ chord:'Fmaj9', lyric:'相聚离开 都有时候' }, { chord:'C/E', lyric:'' }, { chord:'Dsus4', lyric:'没有甚么' }, { chord:'D', lyric:'' }, { chord:'Gsus4', lyric:'会永垂' }, { chord:'G', lyric:'不朽' }],
        [{ chord:'C', lyric:'可是我 有时候 宁愿选择留恋不放手' }, { chord:'G/B', lyric:'' }, { chord:'Am7', lyric:'' }, { chord:'D/F#', lyric:'' }],
        [{ chord:'Em', lyric:'等到风景都看透' }, { chord:'Am7', lyric:'' }, { chord:'Dm7', lyric:'也许你会陪我' }, { chord:'Gsus4', lyric:'看细' }, { chord:'G', lyric:'' }, { chord:'C', lyric:'水长流' }],
      ]},
      { title: '主歌二', lines: [
        [{ chord:'C', lyric:'还没为你把红豆' }, { chord:'G/B', lyric:'' }, { chord:'Am7', lyric:'熬成缠绵的伤口' }, { chord:'Am7/G', lyric:'' }],
        [{ chord:'Fmaj9', lyric:'然后一起分享 会更明白' }, { chord:'C/E', lyric:'' }, { chord:'Dsus4', lyric:'相思' }, { chord:'D', lyric:'' }, { chord:'Gsus4', lyric:'的哀' }, { chord:'G', lyric:'愁' }],
        [{ chord:'C', lyric:'还没好好的感受' }, { chord:'G/B', lyric:'' }, { chord:'Am7', lyric:'醒着亲吻的温柔' }, { chord:'Am7/G', lyric:'' }],
        [{ chord:'Fmaj9', lyric:'可能在我左右 你才追求' }, { chord:'C/E', lyric:'' }, { chord:'Dm7', lyric:'孤独的' }, { chord:'G', lyric:'自由' }],
      ]},
      { title: '副歌', lines: [
        [{ chord:'C', lyric:'有时候 有时候 我会相信一切有尽头' }, { chord:'G/B', lyric:'' }, { chord:'Am7', lyric:'' }, { chord:'Am7/G', lyric:'' }],
        [{ chord:'Fmaj9', lyric:'相聚离开 都有时候' }, { chord:'C/E', lyric:'' }, { chord:'Dsus4', lyric:'没有甚么' }, { chord:'D', lyric:'' }, { chord:'Gsus4', lyric:'会永垂' }, { chord:'G', lyric:'不朽' }],
