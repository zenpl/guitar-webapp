...
const SONGS = [
  ...
  // ──────────────────────────────────────────
  {
    ...
    sections: [
      ...
      { title: '副歌', lines: [
        [{ chord:'', lyric:'我' }, { chord:'Am7', lyric:'亲爱的小孩' }, { chord:'D7', lyric:'为' }, { chord:'', lyric:'什么' }, { chord:'G', lyric:'你不让我看清' }, { chord:'Cmaj7', lyric:'楚' }, { chord:'', lyric:'' }, { chord:'', lyric:'' }],
    ...
    sections: [
      ...
      { title: '副歌', lines: [
        ...
        [
          ...
          { chord:'Esus4', lyric:'' },
          { chord:'', lyric:'' },
          { chord:'E', lyric:'给要给得完整' },
          { chord:'', lyric:'' },
          { chord:'', lyric:'有时' },
          { chord:'C7/E', lyric:'爱美在' },
          { chord:'', lyric:'无法永' },
          { chord:'Gm', lyric:'恒' },
        ],
        [
