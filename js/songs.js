...
const SONGS = [
  ...
  // ──────────────────────────────────────────
  {
    ...
    chords: ['C','G/B','Am7','Am7/G','Fmaj9','C/E','Dm7','G'],
    sections: [
      { title: '主歌一', lines: [
        [{ chord:'C', lyric:'还没好好的感受' }, { chord:'G/B', lyric:'' }, { chord:'Am7', lyric:'雪花绽放的气候' }, { chord:'Am7/G', lyric:'' }],
        [{ chord:'Fmaj9', lyric:'我们一起颤抖 会更明白' }, { chord:'C/E', lyric:'' }, { chord:'Dm7', lyric:'甚么是' }, { chord:'G', lyric:'温柔' }],
        [{ chord:'C', lyric:'还没跟你牵着手' }, { chord:'G/B', lyric:'' }, { chord:'Am7', lyric:'走过荒芜的沙丘' }, { chord:'Am7/G', lyric:'' }],
        [{ chord:'Fmaj9', lyric:'不能从此以后 学会珍惜' }, { chord:'C/E', lyric:'' }, { chord:'Dm7', lyric:'天长和' }, { chord:'G', lyric:'地久' }],
      ]},
      { title: '副歌', lines: [
        [{ chord:'C', lyric:'有时候 有时候 我会相信一切有尽头' }, { chord:'G/B', lyric:'' }, { chord:'Am7', lyric:'' }, { chord:'Am7/G', lyric:'' }],
        [{ chord:'Fmaj9', lyric:'相聚离开 都有时候' }, { chord:'C/E', lyric:'' }, { chord:'Dm7', lyric:'没有甚么会' }, { chord:'G', lyric:'永垂不朽' }],
        [{ chord:'C', lyric:'可是我 有时候 宁愿选择留恋不放手' }, { chord:'G/B', lyric:'' }, { chord:'Am7', lyric:'' }, { chord:'D/F#', lyric:'' }],
        [{ chord:'Em', lyric:'等到风景都看透' }, { chord:'Am7', lyric:'' }, { chord:'Dm7', lyric:'也许你会陪我' }, { chord:'G', lyric:'看细水长' }, { chord:'C', lyric:'流' }],
      ]},
      { title: '主歌二', lines: [
        [{ chord:'C', lyric:'还没为你把红豆' }, { chord:'G/B', lyric:'' }, { chord:'Am7', lyric:'熬成缠绵的伤口' }, { chord:'Am7/G', lyric:'' }],
        [{ chord:'Fmaj9', lyric:'然后一起分享 会更明白' }, { chord:'C/E', lyric:'' }, { chord:'Dm7', lyric:'相思的' }, { chord:'G', lyric:'哀愁' }],
